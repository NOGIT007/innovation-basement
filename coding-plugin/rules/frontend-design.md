...
description: Creative direction for distinctive UI that avoids generic AI aesthetics
---

# Claude Frontend-Design
"The Creative Director" - Avoid generic AI aesthetics

## When This Rule Applies

- Building UI components, pages, or interfaces
- Working with CSS, styling, animations, visual design
- Making aesthetic or visual design decisions
- Frontend development work

## Relation to vibe-coding

**Code complexity should match design ambition:**
- Minimalist design → simple, clean code (vibe-coding philosophy applies)
- Bold/maximalist design → elaborate code with animations/effects OK (design vision applies)
- Both approaches are valid - the key is **INTENTIONALITY**, not complexity level

When doing UI work, BOTH rules apply together with this bridge principle.
